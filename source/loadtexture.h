...
bool init() {
    ...
    heartTexture = IMG_LoadTexture(renderer,"hearttank.png");
    groundTexture = IMG_LoadTexture(renderer,"ground2.png");
    wallTexture = IMG_LoadTexture(renderer,"flowerwall.png");
    steelWallTexture = IMG_LoadTexture(renderer,"steelwall.png");
    enemyTankUpTexture = IMG_LoadTexture(renderer, "enemytankup1.png");
    enemyTankDownTexture = IMG_LoadTexture(renderer, "enemytankdown1.png");
    enemyTankRightTexture = IMG_LoadTexture(renderer, "enemytankright1.png");
    enemyTankLeftTexture = IMG_LoadTexture(renderer, "enemytankleft1.png");
